...
public class ChatScreen(semanticsProvider: SemanticsNodeInteractionsProvider) :
    ComposeScreen<ChatScreen>(
        ...
        viewBuilderAction = { hasTestTag("chatScreen") }) {

    val chatAppBar: KNode = child { hasTestTag("chatAppBar") }
    private val chatAppBarTitle: KNode = chatAppBar.child { hasTestTag("chatAppBarTitle") }
    private val chatAppBarTitleSurface: KNode = chatAppBarTitle.child { hasTestTag("chatAppBarTitleSurface") }
    val chatAppBarTitleImage: KNode = chatAppBarTitleSurface.child { hasTestTag("chatAppBarTitleImage") }
    val chatAppBarTitleIcon: KNode = chatAppBarTitleSurface.child { hasTestTag("chatAppBarTitleIcon") }
    ...
    val chatAppBarBackArrowIcon: KNode = chatAppBarBackArrow.child { hasTestTag("chatAppBarBackArrowIcon") }

    val bottomNav: KNode = child { hasTestTag("bottomNavMenu") }
    private val chatScreenColumn: KNode = child { hasTestTag("chatScreenColumn") }
    val chatScreenMessagesList: KNode = chatScreenColumn.child { hasTestTag("chatScreenMessagesList") }
    ...
    private val receivedChatBubbleText: KNode = receivedChatBubble.child { hasTestTag("receivedChatBubbleText") }
    val receivedMessageText: KNode = receivedChatBubbleText.child { hasTestTag("receivedMessageText") }
    ...
    private val sentChatBubbleTimeRow: KNode = sentChatBubbleText.child { hasTestTag("sentChatBubbleTimeRow") }
    ...
    private val chatInputSendButton: KNode = chatInputTrailingIcon.child { hasTestTag("chatInputSendButton") }
    val chatInputSendButtonIcon: KNode = chatInputSendButton.child { hasTestTag("chatInputSendButtonIcon") }
    private val chatInputCameraButton: KNode = chatInputTrailingIcon.child { hasTestTag("chatInputCameraButton") }
    val chatInputCameraButtonIcon: KNode = chatInputCameraButton.child { hasTestTag("chatInputCameraButtonIcon") }
}
