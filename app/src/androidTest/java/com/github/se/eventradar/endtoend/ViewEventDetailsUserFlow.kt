...
class ViewEventDetailsUserFlow : TestCase() {
  ...
  private val uiState = MutableStateFlow(EventsOverviewUiState(
    eventList = EventList(List(3) { mockEvent.copy(eventName = "Test $it", fireBaseID = "$it") }),
  ))
    ...
    composeTestRule.setContent {
      ...
      MyApplicationTheme {
        NavHost(navController = navController, startDestination = Route.HOME) {
          ...
          composable ("${Route.EVENT_DETAILS}/{eventId}",
