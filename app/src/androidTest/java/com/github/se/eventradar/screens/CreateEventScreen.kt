...
class CreateEventScreen(semanticsProvider: SemanticsNodeInteractionsProvider) :
  ...
  val eventDescriptionTextField: KNode =
      createEventScreenColumn.child { hasTestTag("eventDescriptionTextField") }
  ...
  val locationExposedDropDownMenuBox: KNode =
      createEventScreenColumn.child { hasTestTag("locationExposedDropDownMenuBox") }
  val locationDropDownMenuTextField: KNode =
      locationExposedDropDownMenuBox.child { hasTestTag("locationDropDownMenuTextField") }

  val exposedDropDownMenuBox: KNode =
      createEventScreenColumn.child { hasTestTag("exposedDropDownMenuBox") }
  val ticketNameDropDownMenuTextField: KNode =
      exposedDropDownMenuBox.child { hasTestTag("ticketNameDropDownMenuTextField") }
  val eventCategoryDropDown: KNode =
      exposedDropDownMenuBox.child { hasTestTag("eventCategoryDropDown") }

  val ticketQuantityTextField: KNode =
      createEventScreenColumn.child { hasTestTag("ticketQuantityTextField") }
  val ticketPriceTextField: KNode =
      createEventScreenColumn.child { hasTestTag("ticketPriceTextField") }

  val multiSelectExposedDropDownMenuBox: KNode =
      createEventScreenColumn.child { hasTestTag("multiSelectExposedDropDownMenuBox") }
  val organisersMultiDropDownMenuTextField: KNode =
      multiSelectExposedDropDownMenuBox.child { hasTestTag("organisersMultiDropDownMenuTextField") }
