...
class ViewFriendsProfileViewModelUnitTest {
  ...
  private val mockUser =
    ...
    @get:Rule
    val mainDispatcherRule = ViewFriendsProfileViewModelUnitTest.MainDispatcherRule()
  ...
  fun setUp() {
    ...
    fun viewFriendsProfileDetailsFailureFriendIdDoesNotExist(){
        ...
        viewModel.getFriendProfileDetails()
        verify { Log.d("ViewFriendsProfileViewModel", "Error getting friend's user details for friendUserId ${mockFriend.userId}") }
        unmockkAll()
    }
}
