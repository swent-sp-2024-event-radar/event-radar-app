...
@Composable
fun EventDetails(
  viewModel: EventDetailsViewModel = viewModel(), navigationActions: NavigationActions
) {

  viewModel.getEventData()
  val eventUiState = viewModel.uiState.collectAsState().value

  val componentStyle = EventComponentsStyle(
    MaterialTheme.colorScheme.onSurface,
    MaterialTheme.colorScheme.onSurfaceVariant,
    MaterialTheme.colorScheme.onSurface,
  )

  Scaffold(modifier = Modifier.testTag("EventDetailsScreen"), topBar = {}, bottomBar = {
    ...
    ConstraintLayout(
      ...
      Text(text = eventUiState.eventName,
