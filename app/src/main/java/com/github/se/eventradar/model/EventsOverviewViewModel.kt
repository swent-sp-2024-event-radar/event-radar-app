...
import com.github.se.eventradar.model.di.MockEventModule
import com.github.se.eventradar.model.di.MockUserModule
...
@Inject
constructor(
    @MockEventModule private val eventRepository: IEventRepository,
    @MockUserModule val userRepository: IUserRepository
) : ViewModel() {
